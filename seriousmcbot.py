...
async def liquidity(ctx):
    embed = discord.Embed(
        description="```\n     Providing Liquidity on VVS is quick & easy.\n  Doing so is massively beneficial for the project\n     & will reward you with a percentage of the\n   trading fees generated by Serious Coin on VVS.\n\n     Before adding liquidity, it's essential to\n     understand the concept of impermanent loss. \n```\n> [Learn about Impermanent Loss, a crucial concept in DeFi liquidity pools](https://crypto.com/university/what-is-impermanent-loss#:~:text=Impermanent%20Loss%20occurs%20when%20the,and%20the%20value%20at%20withdrawal)",
        colour=0x219d55
    )
    button = discord.ui.Button(
        style=discord.ButtonStyle.url,
